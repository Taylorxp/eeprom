...
/* MCU IO口操作 */
#define _I2C_SCL_1     PEout(8) = 1
#define _I2C_SCL_0     PEout(8) = 0
#define _I2C_SCL_DAT   PEin(8)
#define _I2C_SCL_IN    GPIOE->CRH &= 0xFFFFFFF0;  GPIOE->CRH |= 0x00000004
#define _I2C_SCL_OUT   GPIOE->CRH &= 0xFFFFFFF0;  GPIOE->CRH |= 0x00000003

#define _I2C_SDA_1     PEout(7) = 1
#define _I2C_SDA_0     PEout(7) = 0
#define _I2C_SDA_DAT   PEin(7)
#define _I2C_SDA_IN    GPIOE->CRL &= 0x0FFFFFFF;  GPIOE->CRL |= 0x40000000
#define _I2C_SDA_OUT   GPIOE->CRL &= 0x0FFFFFFF;  GPIOE->CRL |= 0x30000000
